        ...
        if (LocaleCompare("distort",option+1) == 0)
          {
            ...
            */
            ...
            if (distort_image == (Image *) NULL)
              break;
            InheritException(&distort_image->exception,exception);
            *image=DestroyImage(*image);
            *image=distort_image;
            break;
          }
        ...
        if (LocaleCompare("floodfill",option+1) == 0)
          {
            ...
            */
            ...
            (void) PaintFloodfillImage(*image,channel,&target,geometry.x,
              geometry.y,draw_info,FloodfillMethod);
            break;
          }
        ...
        if (LocaleCompare("polaroid",option+1) == 0)
          {
            ...
            */
            ...
            if (polaroid_image == (Image *) NULL)
              break;
            InheritException(&polaroid_image->exception,exception);
            *image=DestroyImage(*image);
        ...
        if (LocaleCompare("recolor",option+1) == 0)
          {
            ...
            */
            ...
            if (recolor_image == (Image *) NULL)
              break;
            InheritException(&recolor_image->exception,exception);
            *image=DestroyImage(*image);
            *image=recolor_image;
            break;
          }
        ...
        if (LocaleCompare("separate",option+1) == 0)
          {
            ...
            */
            ...
            if (separate_images == (Image *) NULL)
              break;
            InheritException(&separate_images->exception,exception);
            *image=DestroyImage(*image);
        ...
        if (LocaleCompare("segment",option+1) == 0)
          {
            ...
            */
            ...
            if ((flags & SigmaValue) == 0)
              geometry_info.sigma=1.0;
            (void) SegmentImage(*image,image_info->colorspace,
        ...
        if (LocaleCompare("set",option+1) == 0)
          {
            ...
            */
            if (LocaleNCompare(argv[i+1],"registry:",9) == 0)
              (void) DeleteImageRegistry(argv[i+1]);
            else
            ...
            if (*option == '-')
              {
                ...
                if (value != (char *) NULL)
                  {
                    if (LocaleNCompare(argv[i+1],"registry:",9) == 0)
                      (void) SetImageRegistry(StringRegistryType,argv[i+1],
                        value,exception);
                    else
                      if (LocaleNCompare(argv[i+1],"option:",7) == 0)
                        {
        ...
        if (LocaleCompare("sketch",option+1) == 0)
          {
            ...
            */
            ...
            if (sketch_image == (Image *) NULL)
              break;
            InheritException(&sketch_image->exception,exception);
            *image=DestroyImage(*image);
            *image=sketch_image;
            break;
          }
        ...
        if (LocaleCompare("transparent",option+1) == 0)
          {
            ...
            (void) QueryMagickColor(argv[i+1],&target,exception);
            (void) PaintTransparentImage(*image,&target,(Quantum)
              TransparentOpacity);
            break;
          }
        ...
        if (LocaleCompare("unique-colors",option+1) == 0)
          {
            ...
            */
            ...
            if (unique_image == (Image *) NULL)
              break;
            InheritException(&unique_image->exception,exception);
            *image=DestroyImage(*image);
            *image=unique_image;
            break;
          }
...
{ \
  ...
  */
  ...
  for (i=1; i < (long) argc; i++)
  {
        ...
        if (path != (char *) NULL)
          {
            ...
            (void) FormatMagickString(image->filename,MaxTextExtent,"%s%c%s",
    ...
    fire=(MagickBooleanType) ParseMagickOption(MagickMogrifyOptions,MagickFalse,
      option+1);
    if (fire == MagickTrue)
      MogrifyImageStack(image_stack[k],MagickTrue,MagickTrue);
  }
        ...
        if (LocaleCompare("layers",option+1) == 0)
          {
            ...
            switch (method)
            {
              ...
              case OptimizeTransLayer:
              {
                ...
                InheritException(&((*images)->exception),exception);
                break;
              }
