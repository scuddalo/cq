...
#undef LT_USE_MAGICKCORE_POSIX_SUPPORT_DIRENT
#ifdef HAVE_CLOSEDIR
#  ifdef HAVE_OPENDIR
#    ifdef HAVE_READDIR
#      ifdef HAVE_DIRENT_H
#        define LT_USE_MAGICKCORE_POSIX_SUPPORT_DIRENT
#      endif /* HAVE_DIRENT_H */
#    endif /* HAVE_READDIR */
#  endif /* HAVE_OPENDIR */
#endif /* HAVE_CLOSEDIR */
...
#ifndef LT_USE_MAGICKCORE_POSIX_SUPPORT_DIRENT
#  ifdef __WINDOWS__
#    define LT_USE_WINDOWS_DIRENT_EMULATION
#  endif /* __WINDOWS__ */
#endif /* LT_USE_MAGICKCORE_POSIX_SUPPORT_DIRENT */


#ifdef LT_USE_MAGICKCORE_POSIX_SUPPORT_DIRENT
#  include <dirent.h>
