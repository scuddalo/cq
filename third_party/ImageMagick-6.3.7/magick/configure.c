  ...
  ExceptionInfo *exception)
{
  ...
  (void) AppendValueToLinkedList(paths,ConstantString(MAGICKCORE_CONFIGURE_PATH));
#endif
#if defined(MAGICKCORE_SHARE_CONFIGURE_PATH)
  (void) AppendValueToLinkedList(paths,ConstantString(MAGICKCORE_SHARE_CONFIGURE_PATH));
#endif
#if defined(MAGICKCORE_DOCUMENTATION_PATH)
  (void) AppendValueToLinkedList(paths,ConstantString(MAGICKCORE_DOCUMENTATION_PATH));
#endif
