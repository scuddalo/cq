...
#if 0
/* This function is no longer requires -- to be removed */
  ...
  double *vector)
{
  ...
  */
  ...
  return(GaussJordanElimination(matrix,&vector,6UL,1UL));
}
#endif
  ...
  double *vector)
{
  ...
  */
  ...
  return(GaussJordanElimination(matrix,&vector,8UL,1UL));
}
    ...
    case PerspectiveDistortion:
    {
      ...
      */
      ...
      /*
        ...
        Picking destination coordinate from first coordinet pair.  
      */
