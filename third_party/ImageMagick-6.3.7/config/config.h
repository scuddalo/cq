...
#define CODER_PATH "/usr/local/lib/ImageMagick-6.3.7/modules-Q8/coders/"

/* Subdirectory of lib where coder modules are installed */
#define CODER_RELATIVE_PATH "ImageMagick-6.3.7/modules-Q8/coders"

/* Directory where architecture-dependent configuration files live. */
#define CONFIGURE_PATH "/usr/local/lib/ImageMagick-6.3.7/config/"

/* Subdirectory of lib where architecture-dependent configuration files live.
   */
#define CONFIGURE_RELATIVE_PATH "ImageMagick-6.3.7/config"

/* Define if you have DJVU library */
/* #undef DJVU_DELEGATE */

/* Directory where ImageMagick documents live. */
#define DOCUMENTATION_PATH "/usr/local/share/doc/ImageMagick-6.3.7/"
...
#define FILTER_PATH "/usr/local/lib/ImageMagick-6.3.7/modules-Q8/filters/"

/* Subdirectory of lib where filter modules are installed */
#define FILTER_RELATIVE_PATH "ImageMagick-6.3.7/modules-Q8/filters"
...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-6.3.7/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed */
#define LIBRARY_RELATIVE_PATH "ImageMagick-6.3.7"
...
#define PACKAGE_STRING "ImageMagick 6.3.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ImageMagick"

/* Define to the version of this package. */
#define PACKAGE_VERSION "6.3.7"
...
#define SHARE_CONFIGURE_PATH "/usr/local/share/ImageMagick-6.3.7/config/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define SHARE_CONFIGURE_RELATIVE_PATH "ImageMagick-6.3.7/config"

/* Directory where architecture-independent files live. */
#define SHARE_PATH "/usr/local/share/ImageMagick-6.3.7/"
