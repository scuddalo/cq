            ...
            XCFLayerInfo*  inLayerInfo, size_t data_length)
{
  ...
  /* we have to copy the pixels individually since IM uses a different
     ...
     different MAGICKCORE_QUANTUM_DEPTHs!
  */
          ...
          if (length == 128)
            ...
            while (length-- > 0)
            {
              ...
              switch (i) {
                ...
                case 3:
                  q->opacity=(Quantum) (ScaleCharToQuantum((unsigned char) (255UL-data)));
                break;
              }
              q++;
            }
        ...
        else
          {
            ...
            for (j = 0; j < (long) length; j++)
            {
              ...
              switch (i)
              {
                ...
                case 2: q->blue=ScaleCharToQuantum(data);  break;
                case 3:
                  q->opacity=(Quantum) (ScaleCharToQuantum((unsigned char) (255-data)));
                  break;
              }
              q++;
            }
