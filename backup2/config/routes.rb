...
## Added by Ajay
   map.get(:controller => 'search') do |m|
    m.profile_search 'people/search.:format', :action => 'search'
    m.profile_search_results 'people/search/results.:format', :action => 'find_profile'    
  end
## Ended by Ajay
